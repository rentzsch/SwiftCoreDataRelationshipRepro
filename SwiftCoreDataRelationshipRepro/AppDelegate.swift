...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    var applicationFilesDirectory: NSURL {
        // Returns the directory the application uses to store the Core Data store file. This code uses a directory named "com.rentzsch.SwiftCoreDataRelationshipRepro" in the user's Application Support directory.
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        ...
        let url = applicationFilesDirectory.URLByAppendingPathComponent("SwiftCoreDataRelationshipRepro.storedata")
